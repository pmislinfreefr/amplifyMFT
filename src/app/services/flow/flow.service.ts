...
private fetchFlowListFromAPI_FAKE(): Observable<IFlowsList> {
  ...
  return of(fakeData).pipe(
    map(dataFake => this.transformToIFlowsList(dataFake))
  );
}

private fetchFlowListFromAPI(): Observable<IFlowsList> {
  return this.httpClient
    .get<IAPIFlowData>(`${environment.baseUrl}applications`)
    .pipe(
...
private transformToIFlowsList(data: IAPIFlowData): IFlowsList {
  ...
  data.data.forEach(flow => {
    resultList.flows.push({
      ...
      flow_name: flow.model && flow.model.model_data && flow.model.model_data.flow_name || flow.flows.name,
      flow_description: flow.model && flow.model.model_data && flow.model.model_data.flow_description || flow.flows.description,
      contact_email: flow.model && flow.model.model_data && flow.model.model_data.contact_email
                    || flow.flows.contact && flow.flows.contact.email || '',
      contact_firstname: flow.model && flow.model.model_data && flow.model.model_data.contact_firstname
      || flow.flows.contact && flow.flows.contact.firstName || '',
      contact_lastname: flow.model && flow.model.model_data && flow.model.model_data.contact_lastname
      || flow.flows.contact && flow.flows.contact.lastName || '',
      contact_phone: flow.model && flow.model.model_data && flow.model.model_data.contact_phone
      || flow.flows.contact && flow.flows.contact.phone || '',
      contact_jobtitle: flow.model && flow.model.model_data && flow.model.model_data.contact_jobtitle || '',
      source_application_id: flow.model && flow.model.model_data && flow.model.model_data.source_application_id || '',
      source_application_product_id: flow.model && flow.model.model_data && flow.model.model_data.source_application_product_id || '',
      target_application_id: flow.model && flow.model.model_data && flow.model.model_data.target_application_id || '',
      target_application_product_id: flow.model && flow.model.model_data && flow.model.model_data.target_application_product_id || '',
      protocol_pesit_flow_idf: flow.model && flow.model.model_data && flow.model.model_data.protocol_pesit_flow_idf || '',
      source_prop_transfer_action_after_transfer: flow.model && flow.model.model_data
                          && flow.model.model_data.source_prop_transfer_action_after_transfer || '',
      source_prop_file_file_type: flow.model && flow.model.model_data && flow.model.model_data.source_prop_file_file_type || '',
      target_prop_file_target_file_name: flow.model && flow.model.model_data
                          && flow.model.model_data.target_prop_file_target_file_name || '',
      target_prop_file_file_type: flow.model && flow.model.model_data
